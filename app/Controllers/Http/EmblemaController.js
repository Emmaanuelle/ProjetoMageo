...
class EmblemaController {
  ...
  /**
   * Render a form to be used for creating a new emblema.
   * GET emblemas/create
   *
   * @param {object} ctx
   * @param {Request} ctx.request
  ...
  /**
   * Render a form to update an existing emblema.
   * GET emblemas/:id/edit
   *
   * @param {object} ctx
   * @param {Request} ctx.request
   * @param {Response} ctx.response
...
module.exports = EmblemaController
